...
namespace APIGateway.Infrastructure.Middlewares
{
    public class ScopedSpecificSerilogLoggingMiddleware
    {
        ...
        public ScopedSpecificSerilogLoggingMiddleware(RequestDelegate next, ILogger<ScopedSpecificSerilogLoggingMiddleware> logger)
        {
